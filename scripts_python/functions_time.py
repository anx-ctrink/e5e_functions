...
def func_sleep_thread_sub(event, context):  
    ...
    t2 = threading.Thread(name='thread_2', target=func_sleep_thread)
    t1.start()
    t2.start()
    print('Exiting')
...
def func_thread_frontier(event, context):  
    ...
    t1 = threading.Thread(name='thread_1', target=func_get_frontier)
    t2 = threading.Thread(name='thread_2', target=func_sleep_10)
    t1.start()
    t2.start()
    print('Exiting')    
