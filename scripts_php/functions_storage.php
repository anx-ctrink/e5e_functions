...
{
    return func_quota_memory_MB($event, $context, 650);
}

// Test quota memory by generating a 90 MB string
function func_quota_memory_50_MB($event, $context) 
{
    return func_quota_memory_MB($event, $context, 6000000);
}

// Test quota memory by generating a 90 MB string
function func_quota_memory_90_MB($event, $context) 
{
    return func_quota_memory_MB($event, $context, 10000000);
}
